"""
This python script builds the XML files for case7a of the FHR benchmark 
...
mats = openmc.Materials((uoc_19,por_c,si_c,graphite,p_graphite,lm_graphite,flibe,mhc,s_graphite))
mats.export_to_xml()
...
triso_cells = [openmc.Cell(fill=uoc_19, region=-spheres[0]),
