"""
This python script builds the XML files for case4ar of the FHR benchmark 
...
mhc.set_density('atom/b-cm', 6.461439E-2)
...
mats = openmc.Materials((uoc_9,por_c,si_c,graphite,p_graphite,lm_graphite,flibe,mhc,s_graphite,euo_s))
mats.export_to_xml()
...
lattice1.lower_left = (V['A1']['DE']['L']['x'], V['A1']['DE']['L']['y'],-(DE_pitch/2+(z_thickness-1)/2*DE_pitch))
