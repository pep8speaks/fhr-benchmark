...
beta_b(sp,case)
# doppler
print(reactivity_coefficient_b(keff_og=keff,keff_og_unc=keff_unc,keff_new=0.83600,keff_new_unc=0.00003,temp_change=+50))
# flibe 
print(reactivity_coefficient_b(keff_og=keff,keff_og_unc=keff_unc,keff_new=0.83733,keff_new_unc=0.00003,temp_change=+50))
# graphite 
print(reactivity_coefficient_b(keff_og=keff,keff_og_unc=keff_unc,keff_new=0.83398,keff_new_unc=0.00003,temp_change=+50))
